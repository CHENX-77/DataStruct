...
//        temp[0][0] = 2;
//    }
//    if(temp[T_height-1][0]==0){
//        Count++;
//        temp[T_height-1][0] = 2;
//    }
//    if(temp[0][T_width-1]==0){
//        Count++;
//        temp[T_height-1][0] = 2;
//    }
//    if(temp[T_height-1][T_width-1]==0){
//        Count++;
//        temp[T_height-1][0] = 2;
//    }
//
//    //从左边
//    for(i=1,j=0;i<T_height-1;i++,j=0){
//            while(temp[i][j]==0) {
//                Count++;
//                temp[i][j] = 2;
//                j++;
...
//    }
////从右边
//    for(i=1,j=T_width-1;i<T_height-1;i++,j=T_width-1){
//            while(temp[i][j]==0){
//                Count++;
//                temp[i][j]=2;
//                j--;
...
//    }
//    //从下面
//    for(i=T_height-1,j=1;j<T_width-1;i=T_height-1,j++){
//        while(temp[i][j]==0){
//            Count++;
//            temp[i][j]=2;
//            i--;
...
//                sum_one++;
//
//    answer=T_height*T_width;
//    cout<<answer-sum_one<<endl;
//
//}
//
//int main(){
